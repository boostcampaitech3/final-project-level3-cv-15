...
def get_loader(train_data, valid_data,transform, args):
    train_dataset= WrinkletrainDataset(train_data, transform)
    val_dataset= WrinklevalDataset(valid_data, transform)
...
def main():
    ...
    train_df = train_df[['part', 'wrinkle', 'file_name']]
    val_df = val_df[['part', 'wrinkle', 'file_name']]

    train_rm_idx1 = train_df[train_df['wrinkle'] == -1].index
    train_rm_idx2 = train_df[train_df['wrinkle'] == -2].index

    val_rm_idx1 = val_df[val_df['wrinkle'] == -1].index
    val_rm_idx2 = val_df[val_df['wrinkle'] == -2].index
