...
def get_loader(train_data, valid_data,transform, args):
    train_dataset= PigmentationtrainDataset(train_data, transform)
    val_dataset= PigmentationvalDataset(valid_data, transform)
...
def main():
    ...
    train_df = train_df[['part', 'pigmentation', 'file_name']]
    val_df = val_df[['part', 'pigmentation', 'file_name']]

    train_rm_idx1 = train_df[train_df['pigmentation'] == -1].index
    train_rm_idx2 = train_df[train_df['pigmentation'] == -2].index

    val_rm_idx1 = val_df[val_df['pigmentation'] == -1].index
    val_rm_idx2 = val_df[val_df['pigmentation'] == -2].index
