...
def get_loader(train_data, valid_data,transform, args):
    train_dataset= HydrationtrainDataset(train_data, transform)
    val_dataset= HydrationvalDataset(valid_data, transform)
...
def main():
    ...
    train_df = train_df[['part', 'hydration', 'file_name']]
    val_df = val_df[['part', 'hydration', 'file_name']]

    train_rm_idx1 = train_df[train_df['hydration'] == -1].index
    train_rm_idx2 = train_df[train_df['hydration'] == -2].index

    val_rm_idx1 = val_df[val_df['hydration'] == -1].index
    val_rm_idx2 = val_df[val_df['hydration'] == -2].index
